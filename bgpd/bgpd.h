...
DECLARE_HASH(vrf_rd_state_hash, struct vrf_rd_state_entry, item, vrf_rd_state_hash_cmp,
	     vrf_rd_state_hash_key);
...
DECLARE_HASH(vni_rd_state_hash, struct vni_rd_state_entry, item, vni_rd_state_hash_cmp,
	     vni_rd_state_hash_key);
