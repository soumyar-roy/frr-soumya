...
static struct log_ref ferr_lib_warn[] = {
	{
		...
		.description = "The SNMP AgentX library has returned a warning that we should report to the "
		"end user",
	...
	},
	{
		...
		.description = "During sanity checking stream.c has detected an error in the data associated "
	...
	},
	{
		...
		.description = "The Event subsystem has detected a slow process, this typically indicates that "
		"FRR is having trouble completing work in a timely manner. This can be either a "
		"misconfiguration, bug, or some combination thereof. In this case total CPU "
		"time was over 5 seconds. Which indicates that FRR is very busy doing some work "
	...
	},
	{
		...
		.description = "The Event subsystem has detected a slow process, this typically indicates that "
		"FRR is having trouble completing work in a timely manner. This can be either a "
		"misconfiguration, bug or some combination thereof. In this case total WALL "
		"time was over 5 seconds. Which indicates that FRR might be having trouble "
		"being scheduled or some system call is delaying",
		.suggestion = "Gather log data and open an Issue",
	},
	{
		.code = EC_LIB_STARVE_THREAD,
		.title = "The Event subsystem has detected a thread starvation issue",
		.description = "The event subsystem has detected a thread starvation issue. This typically "
		"indicates that the system FRR is running on is heavily loaded and this load "
		"might be impacting FRR's ability to handle events in a timely fashion",
		.suggestion = "Gather log data and open an Issue",
	},
	{
		.code = EC_LIB_NO_THREAD,
		.title = "The Event subsystem has detected an internal FD problem",
		.description = "The Event subsystem has detected a file descriptor read/write event without an "
		"associated handling function. This is a bug, please collect log data and open "
		"an issue.",
		.suggestion = "Gather log data and open an Issue",
	},
	{
		.code = EC_LIB_TIMER_TOO_LONG,
		.title = "The Event subsystem has detected an internal timer that is "
		"scheduled to pop in greater than one year",
		.description = "The Event subsystem has detected a timer being started that will pop in a "
		"timer that is greater than one year. This is a bug, please collect log data "
		"and open an issue.",
		.suggestion = "Gather log data and open an Issue",
	},
	{
		...
		.description = "The Route-Map subsystem has detected a route-map depth of RMAP_RECURSION_LIMIT "
		"and has stopped processing",
		.suggestion = "Re-work the Route-Map in question to not have so many route-map statements, or "
		"recompile FRR with a higher limit",
	},
	{
		.code = EC_LIB_BACKUP_CONFIG,
		.title = "Unable to open configuration file",
		.description = "The config subsystem attempted to read in it's configuration file which "
		"failed, so we are falling back to the backup config file to see if it is "
		"available",
	...
	},
	{
		...
		.description = "The VRF subsystem, during initialization, has found a parsing error with input "
		"it has received",
	...
	},
	{
		...
		.description = "The northbound subsystem has detected that YANG data has been truncated as the "
		"given buffer wasn't big enough",
		.suggestion = "Gather log data and open an Issue",
	},
	{
	...
	},
	{
		...
		.description = "The northbound subsystem has detected an error while loading a YANG module "
		"translator",
		.suggestion = "Ensure the YANG module translator file is valid. See documentation for further "
		"information.",
	},
	{
		.code = EC_LIB_YANG_TRANSLATION_ERROR,
		.title = "YANG translation error",
		.description = "The northbound subsystem has detected an error while performing a YANG XPath "
		"translation",
		.suggestion = "Gather log data and open an Issue",
	},
	{
		...
		.description = "An error occurred while initializing the northbound database. As a result, the "
		"configuration rollback feature won't work as expected.",
	...
	},
	{
		...
		.description = "The northbound subsystem, during initialization, has detected a callback that "
		"doesn't need to be implemented",
		.suggestion = "This is a bug; please report it",
	},
	{
		.code = EC_LIB_NB_CB_CONFIG_VALIDATE,
		.title = "A northbound configuration callback has failed in the "
		"VALIDATE phase",
		.description = "A callback used to process a configuration change has returned a validation "
		"error",
		.suggestion = "The provided configuration is invalid. Fix any inconsistency and try again.",
	},
	{
		.code = EC_LIB_NB_CB_CONFIG_PREPARE,
		.title = "A northbound configuration callback has failed in the PREPARE "
		"phase",
		.description = "A callback used to process a configuration change has returned a resource "
		"allocation error",
	...
	},
	{
		...
		.description = "The northbound subsystem has detected that a callback used to fetch "
		"operational data has returned an error",
		.suggestion = "Gather log data and open an Issue",
	},
	{
		.code = EC_LIB_NB_CB_RPC,
		.title = "A northbound RPC callback has failed",
		.description = "The northbound subsystem has detected that a callback used to process YANG "
		"RPCs/actions has returned an error",
		.suggestion = "The log message should contain further details on the specific error that "
		"occurred; investigate the reported error.",
	},
	{
		...
		.suggestion = "Check the log messages to see the validation errors and edit the candidate "
		"configuration to fix them",
	},
	{
	...
	},
	{
		...
		.description = "The northbound subsystem failed to record a configuration transaction in the "
		"northbound database",
		.suggestion = "Gather log data and open an Issue",
	},
	{
...
static struct log_ref ferr_lib_err[] = {
	...
	{
		.code = EC_LIB_SOCKET,
		.title = "Socket operation failed",
		.description = "Socket operation failed (creation, binding, options, or communication)",
		.suggestion = "Check system resources, FRR user permissions, and file descriptor limits. "
		"Verify kernel socket flag support. Restart affected services if needed. If "
		"issues persist, open an issue.",
	},
	{
		.code = EC_LIB_ZAPI_MISSMATCH,
		.title = "ZAPI Error",
		.description = "A version miss-match has been detected between zebra and client protocol",
		.suggestion = "Two different versions of FRR have been installed and the install is not "
		"properly setup. Completely stop FRR, remove it from the system and reinstall. "
		"Typically only developers should see this issue.",
	},
	{
		.code = EC_LIB_ZAPI_ENCODE,
		.title = "ZAPI Error",
		.description = "The ZAPI subsystem has detected an encoding issue, between zebra and a client "
		"protocol",
	...
	},
	{
		...
		.description = "FRR has detected an issue where new development has not properly updated all "
		"code paths.",
	...
	},
	{
		...
		.description = "FRR has detected an issue with the Zero MQ subsystem and ZeroMQ is not working "
		"properly now",
		.suggestion = "Open an Issue with all relevant log files and restart FRR",
	},
	{
		...
		.description = "FRR was not compiled with support for a particular feature, or it is not "
		"available on the current platform",
		.suggestion = "Recompile FRR with the feature enabled, or find out what platforms support the "
		"feature",
	},
	{
	...
	},
	{
		...
		.description = "The northbound subsystem has detected an attempt to load a YANG module that is "
		"already loaded",
		.suggestion = "This is a bug; please report it",
	},
	{
		...
		.description = "An error has occurred while converting a YANG data value from string to binary "
	...
	},
	{
		...
		.description = "The northbound subsystem failed to find a YANG data node that was supposed to "
		"exist",
		.suggestion = "This is a bug; please report it",
	},
	{
		...
		.description = "The northbound subsystem, during initialization, has detected a missing "
		"callback for one node of the loaded YANG modules",
		.suggestion = "This is a bug; please report it",
	},
	{
		.code = EC_LIB_NB_CB_INVALID_PRIO,
		.title = "Northbound callback has an invalid priority",
		.description = "The northbound subsystem, during initialization, has detected a callback whose "
		"priority is invalid",
		.suggestion = "This is a bug; please report it",
	},
	{
		...
		.description = "The northbound subsystem, during initialization, has detected one or more "
		"errors while loading the northbound callbacks",
		.suggestion = "This is a bug; please report it",
	},
	{
		.code = EC_LIB_LIBYANG,
		.title = "The libyang library returned an error",
		.description = "The northbound subsystem has detected that the libyang library returned an "
		"error",
		.suggestion = "Open an Issue with all relevant log files and restart FRR",
	},
	{
		...
		.description = "The northbound subsystem, during initialization, has detected that a libyang "
	...
	},
	{
		...
		.description = "Upon startup FRR failed to properly initialize and startup the Sysrepo "
		"northbound plugin",
	...
	},
	{
		...
		.description = "The northbound subsystem has detected that the libsysrepo library returned an "
		"error",
		.suggestion = "Open an Issue with all relevant log files and restart FRR",
	},
	{
		...
		.description = "Upon startup FRR failed to properly initialize and startup the gRPC northbound "
		"plugin",
		.suggestion = "Check if the gRPC libraries are installed correctly in the system.",
	},
	{
		.code = EC_LIB_NB_CB_CONFIG_ABORT,
		.title = "A northbound configuration callback has failed in the ABORT "
		"phase",
		.description = "A callback used to process a configuration change has returned an error while "
		"trying to abort a change",
		.suggestion = "Gather log data and open an Issue.",
	},
	{
		.code = EC_LIB_NB_CB_CONFIG_APPLY,
		.title = "A northbound configuration callback has failed in the APPLY "
		"phase",
		.description = "A callback used to process a configuration change has returned an error while "
	...
	},
	{
		...
		.suggestion = "Ensure that DNS is working properly and the hostname is configured in dns. If "
		"you are still seeing this error, open an issue",
	},
	{
		.code = END_FERR,
	}
